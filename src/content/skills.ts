...
export const skillsData: SkillsLine[] = [
  ...
  },
  {
    ...
    skills: [
      [
        { name: "Kubernetes", expertise: 60, logo: "skill-icons:kubernetes" },
        { name: "AWS", expertise: 60, logo: "skill-icons:aws-light" },
        { name: "GCP", expertise: 60, logo: "skill-icons:gcp-light" },
        { name: "Docker", expertise: 70, logo: "skill-icons:docker" },
      ...
      [
        ...
        { name: "Networking", expertise: 70, logo: "lucide:network" },
